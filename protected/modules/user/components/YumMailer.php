...
class YumMailer {
	static public function send($to, $subject = null, $body = null, $header = null) {
		...
		if(Yum::module()->mailer == 'swift') {
			...
			$mailer->Username = 'noreply.codepac@gmail.com';
			$mailer->Password = 'codepac12345';
                        $mailer->SetFrom($to['from'], $to['from_name']); //FIXME
                        $mailer->AddAddress($to['to'],$to['to_name'] ); //FIXME
